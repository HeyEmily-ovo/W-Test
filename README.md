...
**W-Test** 是一个集成了多种心理学测试的集合网站，涵盖 MBTI 人格测试、历史人物人格测试、恋爱类型测试、心理成熟度测试、动物人格测试、暗黑人格测试、塔罗占卜等。只需一次点击，即可跳转到你感兴趣的测试，开启自我探索之旅。
...
| [塔罗占卜](tests/tarot/) | 🔮 | 78 张牌 | ~3 分钟 | 经典韦特塔罗牌在线占卜，5 种牌阵 + v2.0 数据驱动深度解读（每张牌配专属详解/象征/建议），聆听潜意识的低语 | 📖 78 张牌完整图鉴 | ✅ |
...
- **📖 类型图鉴**：每个测试配套完整图鉴——MBTI 16 种人格档案、历史人物画廊、恋爱类型配对矩阵、动物人格 CP 组合、心理成熟度五级阶梯、暗黑人格 8 型完全档案、塔罗 78 张牌完整数据库（含正逆位详解、象征解读、行动建议及五大领域专属解读）
- **🌓 浅/深色主题**：一键切换，偏好自动记忆
